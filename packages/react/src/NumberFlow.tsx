...
// Use a different element name than @number-flow/react so both can coexist
// on one page (e.g. during a migration):
define('number-flow-yceffort-react', NumberFlowElement)
    ...
    return (
      ...
      <number-flow-yceffort-react
        ...
        dangerouslySetInnerHTML={{
          __html: BROWSER
            ? ''
            : renderInnerHTML(data, {nonce, elementSuffix: '-yceffort-react'}),
        }}
