...
A drop-in compatible fork of
[@number-flow/react](https://github.com/barvian/number-flow) (MIT, © Maxwell
Barvian). Its hybrid (WAAPI/rAF) engine keeps **the same animations working
down to Chrome 66 / iOS ~13**.
...
See the [repository README](https://github.com/yceffort/number-flow) for
details.

## License

[MIT](https://github.com/yceffort/number-flow/blob/main/LICENSE.md).
Original [@number-flow/react](https://github.com/barvian/number-flow) ©
